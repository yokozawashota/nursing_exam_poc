            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      ...
                      icon: Icon(_obscureApi ? Icons.visibility : Icons.visibility_off),
                      onPressed: () => setState(() => _obscureApi = !_obscureApi),
                    ),
                  ),
                  validator: (v) {
                    // 空は許容（後で設定する可能性があるため）
                    // 入力がある場合は "sk-" 始まりだけ軽くチェック
                    final s = (v ?? '').trim();
                ...
                _buildSlider(
                  ...
                  onChanged: (v) => setState(() => _fiveChoiceProb = _clampPercent(v)),
                ),
                const SizedBox(height: 20),
                ...
                _buildSlider(
                  ...
                  onChanged: (v) => setState(() => _incorrectProb = _clampPercent(v)),
                ),
                const SizedBox(height: 20),
                ...
                _buildSlider(
                  ...
                  value: _multipleProb,
                  onChanged: (v) => setState(() => _multipleProb = _clampPercent(v)),
                ),
